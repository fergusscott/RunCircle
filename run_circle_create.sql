...
insert into profile (avg_distance_miles, pace_per_mile, avg_duration, runs, preferred_location, 
		handle, hidden, user_id) values
        (5.4, 7.8,42.12, 47, 1, "fergoscotty", 0,1), 
        (7.4, 8.2,60.68, 108, 1, "fujitaruns", 0,2),
        (5.2, 7.5, 39.28,44,1, "swedenrunner", 0,3),
        (7.1, 8.3,58.93,25, 1, "kelly.jones101", 1,4), 
        (4.2, 9.2, 38.64,47, 1, "annerun111", 0, 5), 
        (3.2, 9.8, 31.36,53, 1, "allenallin", 0, 6), 
        (6.6, 6.8, 44.68,24, 1, "rashidainarush", 0,7), 
        (5.6, 5.7, 31.92,4, 1, "michael.scottt", 1, 8), 
        (7.6, 8.2, 62.31,45,1, "oprahoprah11", 0, 9), 
        (6.2, 9.7, 60.14,98, 1, "daggerjogger", 0,10), 
        (5.2, 8.2, 42.64,14, 2, "randerunner", 1, 11), 
        (6.1, 6.8, 41.48,34, 2, "donaldduck", 1,12), 
        (7.2, 9.0, 64.80,22, 2, "hillaryhillruns", 0,13), 
        (5.1,10.0, 60.00,65, 2, "feeltheburn", 0,14), 
        (9.8, 7.6, 74.48,10, 2, "judybates999", 0,15), 
        (8.4, 9.2, 77.28,54, 2, "runlover22", 0,16), 
        (6.3, 7.2, 45.36,43, 2, "comerunwithme", 0,17), 
        (4.2, 9.2, 38.64,65, 2, "kashmoneybb", 0,18), 
        (2.0, 12.00, 24,112, 2, "thedukeofboston", 0,19),
        (5.5,7.9, 43.45,54, 2, "sonofdavid", 1, 20), 
        (4.5, 8.5, 38.25,28, 3, "gr8booksjane", 0, 21), 
        (5.6, 6.4, 35.84,34,3, "freddyboiiii", 0,22), 
        (3.2, 9.1, 29.12,45, 3, "portiagohard", 0,23), 
        (4.5, 8.2, 36.90, 44,3, "samslammer", 0,24), 
        (6.4, 8.7, 55.68,38, 3, "assshlleeeeeeigh", 1, 25), 
        (5.6, 8.6, 48.16, 27, 3, "ardieofrunning", 0,26), 
        (4.6, 9.1, 41.85, 53,3, "theblackestswan", 0, 27), 
        (5.7, 8.2, 46.73, 27, 3, "benrunben1", 0,28), 
        (7.4, 6.8, 46.73, 67, 3, "IreneIran", 1, 29), 
        (8.5, 7.5, 63.75,34, 3, "keanurunning", 0, 30), 
        (10, 8.6, 86.00,39, 4, "robbinraces", 1, 31), 
        (4.3, 7.6, 32.68,56, 4, "runningbrodie", 0, 32), 
        (6.6, 8.2, 54.12,12, 4, "gymnastrunning", 0, 33), 
        (5.9, 6.5, 38.35,7, 4, "fruitforall", 0,34), 
        (12.2, 9.4, 114.68,45, 4, "jumpinggeorge", 1, 35), 
        (5.6, 8.3, 46.48,23, 4, "urchance2run", 0,36), 
        (4.9, 5.6, 27.44,29, 4, "margiemarg", 0, 37), 
        (7.8, 8.1, 63.18,62, 4, "allforalice483", 1, 38), 
        (6.7, 8.0, 53.60,65, 4, "dunnersdunlop", 0, 39), 
        (7.5, 7.5, 56.25,45, 4, "somersjoggr888", 0,40), 
        (5.4, 6.2, 33.48,61, 5, "chucker101", 1,41), 
        (9.3, 10.0, 93.00,45, 5, "allforthebeer", 0,42),
        (3.2, 10.1, 32.32,47, 5, "quintuplequintin", 0,43), 
        (5.6, 9.0, 50.4,39, 5, "wobblywollonga", 1, 44), 
        (4.1, 7.6, 31.16,12, 5, "runnerRAMI", 0,45), 
        (6.7, 9.8, 65.66,27, 5, "zippiezoe", 0, 46), 
        (9.0, 6.0, 54.00,29, 5, "fastfreddie", 0,47), 
        (6.3, 8.5, 53.55,30, 5, "horseyharriett", 0, 48), 
        (5.5, 7.9, 43.45,75, 5, "bustinboksa", 1, 49), 
        (7.8, 8.5, 66.30,103, 5, "fastlikehawks", 0,50);
        select * from profile;
